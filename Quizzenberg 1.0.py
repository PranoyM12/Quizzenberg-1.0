...
questions = [
    ...
    "\'Convulsions\' disease is caused by the deficiency of ",
    ...
    "Name the heaviest naturally occuring element:",
    "Which element is stored in water?",
    "Alcohol (Ethanol) is denatured with which of the following substances?",
]

answers_choice = [
    ["Glucose Unit of Cane Sugar","Glucose Unit of Cellulose","Fructose Unit of Cane Sugar","Galactose Unit of Lactose"],
    ["Vitamin K", "Vitamin B6", "Vitamin D", "Vitamin A"],
    ["Formation of Amino Acids","Loss of Primary Structure","Loss of Both Primary and Secondary Structures","Loss of Both Secondary and Tertiary Structures"],
    ["Peptide bond","Hydrogen bond","Van der Waals force", "Dipole Association"],
    ["Pyridoxine","Thiamine","Tocopherol","Riboflavin"],
    ["Silicon","Sulphur","Nitrogen","Chlorine"],
    ["Iron","Cobalt","Zinc","Magnesium"],
    ["Plutonium","Uranium","Cadmium","Platinum"],
    ["White Phosphorus","Sulphur","Carbon","Iodine"],
    ["Glycerol","Pyridine & Copper Sulphate","Aniline","Ether & Ethanol"],
]
